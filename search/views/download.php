...
// 检查用户是否有权限
if (!isset($_SESSION['username']) || !in_array($_SESSION['username'], ['5278626', '2383615282', '2358494761', '1956013526'])) {
...
// 存储桶访问凭证和信息
$accessKey = 'AbQNwMT3rAoG2Sq2';
$secretKey = 'FGzXUKPStwSd7xTBeYGhk3bBDnWkLe';
$bucketName = 'icebear';
$region = 'cn-sy1';
